...
for (const menuItem of menuItems) {
    ...
    menuItem.DOM.el.addEventListener('click', () => {
        ...
        .fromTo(menuItem.contentItem.DOM.backCtrl, {
            opacity: 0,
            yPercent: 100
        }, {
            opacity: 1,
        ...
        .fromTo([menuItem.contentItem.DOM.carousel], {
            opacity: 0,
            yPercent: 100
        }, {
            opacity: 1,
    ...
    menuItem.contentItem.DOM.backCtrl.addEventListener('click', () => {
        ...
        .addLabel('content', 0)
        .to(menuItem.contentItem.DOM.backCtrl, {
            opacity: 0,
            yPercent: -100
        }, 'content')
        ...
        .to(menuItem.contentItem.DOM.carousel, {
            opacity: 0
        }, 'content')
        .add(() => {
            // Show one image rather than the four together
